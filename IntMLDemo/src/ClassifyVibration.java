...
public class ClassifyVibration extends PApplet {
	...
	String[] classNames = {"neutral", "front_tap", "back_tap"};
	int classIndex = 0;
	int dataCount = 0;
	...
	public void saveClassifier(MLClassifier classifier) throws Exception {
		
		ObjectOutputStream oos = new ObjectOutputStream(
		         new FileOutputStream("/Users/User/Desktop/209/IntMLDemo/models/m1.model"));
		oos.writeObject(classifier);
		oos.flush();
		oos.close();
	
		}
	public MLClassifier loadClassifier() throws Exception {
		ObjectInputStream ois = new ObjectInputStream(
                new FileInputStream("/Users/User/Desktop/209/IntMLDemo/models/m1.model"));
		MLClassifier classifierr = (MLClassifier) ois.readObject();
		ois.close();
		return classifierr;
	}
	/*CT edit end*/
